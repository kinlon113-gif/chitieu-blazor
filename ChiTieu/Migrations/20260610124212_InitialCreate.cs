    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedFunds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedFunds_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SplitBills_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Month = table.Column<string>(type: "text", nullable: false),
                    FromEmail = table.Column<bool>(type: "boolean", nullable: false),
                    VcbOrderId = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FundTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FundTransactions_SharedFunds_FundId",
                        column: x => x.FundId,
                        principalTable: "SharedFunds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SplitBillId = table.Column<int>(type: "integer", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SplitBillItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SplitBillItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SplitBillItems_SplitBills_SplitBillId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Budgets_GroupId_CategoryId_Month",
                table: "Budgets",
                columns: new[] { "GroupId", "CategoryId", "Month" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FundTransactions_UserId",
                table: "FundTransactions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedFunds_GroupId",
                table: "SharedFunds",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_SplitBillItems_SplitBillId",
                table: "SplitBillItems",
                column: "SplitBillId");

            migrationBuilder.CreateIndex(
                name: "IX_SplitBillItems_UserId",
                table: "SplitBillItems",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SplitBills_GroupId",
                table: "SplitBills",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_GroupId_Month",
                table: "Transactions",
                columns: new[] { "GroupId", "Month" });
